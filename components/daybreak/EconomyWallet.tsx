...
export default function EconomyWallet() {
  ...
  const load = async () => {
    ...
    setLoading(true);
    try { setData(await authedFetch<Account>('/api/economy/account')); }
    catch { setError('Credits are unavailable right now.'); }
