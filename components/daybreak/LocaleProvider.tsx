...
const copy: Record<Locale, Record<string, string>> = {
  ...
  es: {
    ...
    'landing.tokenized': 'Acciones on-chain', 'landing.hero1': 'Tu mundo.', 'landing.hero2': 'Tus acciones.', 'landing.heroBody': 'Descubre empresas, compara sus instrumentos onchain compatibles y únete a los círculos de lo que tienes.', 'landing.walletNote': 'Explora sin cartera. Las cotizaciones nunca crean una transacción.',
  ...
  pt: {
    ...
    'landing.tokenized': 'Ações on-chain', 'landing.hero1': 'Seu mundo.', 'landing.hero2': 'Suas ações.', 'landing.heroBody': 'Descubra empresas, compare os instrumentos onchain compatíveis e participe dos círculos do que você possui.', 'landing.walletNote': 'Explore sem carteira. A revisão de cotação nunca cria uma transação.',
  ...
  zh: {
    ...
    'landing.tokenized': '链上股票', 'landing.hero1': '你的世界。', 'landing.hero2': '你的股票。', 'landing.heroBody': '发现公司，比较其支持的链上产品，并加入与你持仓相关的圈子。', 'landing.walletNote': '无需钱包即可探索。报价预览不会创建交易。',
