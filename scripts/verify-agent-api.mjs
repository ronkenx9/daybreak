...
const capabilities=fs.readFileSync(required[0],'utf8');assert(capabilities.includes('flashLimitOrders: isAgentFlashApiEnabled'),'Flash capability must reflect server configuration');
