// Typed shapes mirrored from Bankr documentation (2026-09-06). Not verified
// against live responses — see docs/bankr/CAPABILITY-MATRIX.md.
...
export interface DeployRequest {
  chain: 'base'; name: string; symbol: string; supply?: number;
  ...
  quoteOnlyFees?: boolean; degenMode?: boolean; simulateOnly?: boolean;
}
export interface DeployResult {
  txHash?: string; tokenAddress?: string; poolId?: string; chainId?: number;
  status?: string; feeDistribution?: unknown;
}
