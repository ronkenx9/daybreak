/** Read-only fragments for xStocks on X Layer. */

// Backed xStock token. It rebases: balanceOf = shares * multiplier / 1e18, so
// shares are recovered by dividing by multiplier(). `paused` stops transfers.
...
// ERC-4626 wrapper (wTSLAx etc.) over the rebasing token.
